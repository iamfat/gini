...
class Those extends \Gini\PHPUnit\TestCase\CLI
{
    ...
    public function testMeet() {
        ...
        $those->makeSQL();
        $this->assertAttributeEquals('SELECT DISTINCT "t0"."id","t0"."_extra","t0"."name","t0"."money","t0"."father_id","t0"."description" FROM "user" AS "t0" WHERE "t0"."name" LIKE \'%a%\' AND ("t0"."id" IN (\'1\', \'2\', \'3\') or "t0"."name" LIKE \'%g%\')','SQL',$those);
        ...
        $those->makeSQL();
        $this->assertAttributeEquals('SELECT DISTINCT "t0"."id","t0"."_extra","t0"."room_id","t0"."user_id" FROM "room_member" AS "t0" INNER JOIN "room" AS "t1" ON "t0"."room_id"="t1"."id" INNER JOIN "user" AS "t2" ON "t0"."user_id"="t2"."id" WHERE "t1"."name" LIKE \'%a%\' AND "t2"."name" LIKE \'%b%\'','SQL',$those);
        ...
        $those->makeSQL();
        $this->assertAttributeEquals('SELECT DISTINCT "t0"."id","t0"."_extra","t0"."room_id","t0"."user_id" FROM "room_member" AS "t0" INNER JOIN "room" AS "t1" ON "t0"."room_id"="t1"."id" INNER JOIN "user" AS "t2" ON "t0"."user_id"="t2"."id" WHERE "t1"."name" LIKE \'%a%\' AND (("t2"."money">=\'10\' AND "t2"."money"<\'20\') or "t1"."name"=\'c\')','SQL',$those);
        ...
        $those->makeSQL();
        $this->assertAttributeEquals('SELECT DISTINCT "t0"."id","t0"."_extra","t0"."room_id","t0"."user_id" FROM "room_member" AS "t0" INNER JOIN "room" AS "t1" ON "t0"."room_id"="t1"."id" INNER JOIN "user" AS "t2" ON "t0"."user_id"="t2"."id" WHERE "t1"."name" LIKE \'%a%\' AND (("t2"."money">=\'10\' AND "t2"."money"<\'20\') or ("t1"."name"=\'c\' or "t2"."name"=\'b\') or ("t0"."user_id"=0 and "t0"."room" IS NULL))','SQL',$those);
